...
class Stats(commands.Cog):
    ...
    async def send_stats(self): # Не забудь про async
        ...
        flask_server_ip = 'http://141.144.236.91:44444'  # Пример адреса, замени на актуальный
...
# Настраиваем общие параметры графиков
        ...
        plt.savefig('d1_usage.png', facecolor=fig.get_facecolor(), edgecolor='none')
        plt.close()
        
        title = "D1"
        embed = Embed(title=title)
        response = requests.get('http://141.144.236.91:44444/stats')
        ...
        if is_online:
            ...
            embed.set_image(file=disnake.File("/home/container/d1_usage.png"))
        else:
